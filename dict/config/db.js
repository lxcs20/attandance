...
exports.LockEntity = exports.AttandanceEntity = exports.UserEntity = void 0;
const user_model_1 = __importDefault(require("../model/user.model"));
const attandance_model_1 = __importDefault(require("../model/attandance.model"));
const lock_model_1 = __importDefault(require("../model/lock.model"));
...
exports.LockEntity = (0, lock_model_1.default)('lock', db_Connection);
exports.UserEntity.hasMany(exports.AttandanceEntity);
exports.UserEntity.hasOne(exports.LockEntity);
exports.AttandanceEntity.belongsTo(exports.UserEntity);
exports.LockEntity.belongsTo(exports.UserEntity);
